...
def cadastro():
        ...
        valor = input('[*] Digite o valor que deseja cobrar (ex: 123.45): ')
        cidade.upper()  
        ...
        cpf_formatado = cpf.replace(cpf[:4],'****',1)
...
if __name__ == '__main__':
    ...
    Payload('nome', '12345678900', '1.00', 'Cidade Ficticia', 'LOJA01').gerarPayload()
